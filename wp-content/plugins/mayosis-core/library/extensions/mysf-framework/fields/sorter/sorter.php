 ...
 *
 */
if ( ! class_exists( 'MYSF_Field_sorter' ) ) {
  class MYSF_Field_sorter extends MYSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'mysf' ),
        'disabled_title' => esc_html__( 'Disabled', 'mysf' ),
      ) );
      ...
      echo '<div class="mysf-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="mysf-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="mysf-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="mysf-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="mysf-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="mysf-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="mysf-disabled">';
