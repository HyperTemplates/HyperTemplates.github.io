 ...
 *
 */
if ( ! class_exists( 'MYSF_Field_upload' ) ) {
  class MYSF_Field_upload extends MYSF_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="mysf--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary mysf--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button button-secondary mysf-warning-primary mysf--remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '</div>';
