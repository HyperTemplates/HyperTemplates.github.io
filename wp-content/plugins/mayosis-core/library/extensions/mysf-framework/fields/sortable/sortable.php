 ...
 *
 */
if ( ! class_exists( 'MYSF_Field_sortable' ) ) {
  class MYSF_Field_sortable extends MYSF_Fields {
    ...
    public function render() {
      ...
      echo '<div class="mysf-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="mysf-sortable-item">';

          echo '<div class="mysf-sortable-content">';
          ...
          MYSF::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="mysf-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
