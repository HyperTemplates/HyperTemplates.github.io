 ...
 *
 */
if ( ! class_exists( 'MYSF_Field_palette' ) ) {
  class MYSF_Field_palette extends MYSF_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="mysf-siblings mysf--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' mysf--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="mysf--sibling mysf--palette'. esc_attr( $active ) .'">';
