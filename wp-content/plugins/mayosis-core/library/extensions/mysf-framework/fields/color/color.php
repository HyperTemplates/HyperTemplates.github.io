 ...
 *
 */
if ( ! class_exists( 'MYSF_Field_color' ) ) {
  class MYSF_Field_color extends MYSF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="mysf-color"'. $default_attr . $this->field_attributes() .'/>';
