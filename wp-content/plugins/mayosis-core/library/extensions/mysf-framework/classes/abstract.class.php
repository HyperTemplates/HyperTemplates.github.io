 ...
 *
 */
if ( ! class_exists( 'MYSF_Abstract' ) ) {
  abstract class MYSF_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        MYSF::$css = apply_filters( "mysf_{$this->unique}_output_css", MYSF::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'MYSF_Field_' . $field_type;
