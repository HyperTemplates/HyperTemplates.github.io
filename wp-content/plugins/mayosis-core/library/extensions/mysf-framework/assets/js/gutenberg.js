 ...
 * -----------------------------------------------------------
 *
 * Mysf Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.mysf_gutenberg_blocks ) { return; }

  Object.values(window.mysf_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType('mysf-gutenberg-block/block-'+block.hash, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'mysf-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.hash,
              className: 'is-secondary mysf-shortcode-button',
              onClick: function () {
                window.mysf_gutenberg_props = props;
              },
            }, block.button_title ),
