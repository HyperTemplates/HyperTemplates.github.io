...
(function($) {
  ...
  function MYSFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  MYSFAjaxChosen.prototype.init = function() {
  ...
  MYSFAjaxChosen.prototype.events = function() {
  ...
  MYSFAjaxChosen.prototype.search_field_focused = function() {
  ...
  MYSFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  MYSFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('mysf-chosen', _this.options.data).done( function( response ) {
  ...
  MYSFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.mysf-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.MYSFChosenOrder($hidden_value, true);
  ...
  $.fn.MYSFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new MYSFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, MYSFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  MYSFAbstractChosenOrder = (function() {

    function MYSFAbstractChosenOrder() {}

    MYSFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    MYSFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    MYSFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    MYSFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    MYSFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    MYSFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    MYSFAbstractChosenOrder.MYSFChosenOrder = function(select, order, force) {
    ...
    return MYSFAbstractChosenOrder;
  ...
  $.fn.extend({
    MYSFChosenOrder: function(order, force) {
      return _MYSFChosenOrder.MYSFChosenOrder(this, order, force);
    }
  });

  this._MYSFChosenOrder = (function(_super) {
    __extends(_MYSFChosenOrder, _super);

    function _MYSFChosenOrder() {
      _ref = _MYSFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _MYSFChosenOrder.relAttributeName = 'data-option-array-index';

    _MYSFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _MYSFChosenOrder.getDOMElement = function(element) {
    ...
    _MYSFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _MYSFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _MYSFChosenOrder;

  })(MYSFAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('mysf-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Mysf: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Mysf: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectMYSF = FormSerializer.serializeObject;
    $.fn.serializeJSONMYSF   = FormSerializer.serializeJSON;
  }
