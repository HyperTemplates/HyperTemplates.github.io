...
?>
<div class="mayosis-posts-found" data-found="<?php echo esc_attr( $posts_found_count ); ?>">
<p><?php
    if( $posts_found_count !== NULL ) {
        $class = ( $posts_found_count > 1 ) ? 'mayosis-posts-found-number mayosis-plural' : 'mayosis-posts-found-number';
