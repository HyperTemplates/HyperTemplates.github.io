...
Mayosis_Option::add_section( 'header-presets', array(
    ...
    'panel' => 'header',
    'priority' => '16',
    'description' => __( 'Here are the mayosis prebuilt header.you can switch them to check. Remind that after choose another preset & save your site header will be changed', 'mayosis-core' ),
) );

Mayosis_Option::add_field( 'mayo_config', array(
    'type'        => 'preset',
    'settings'    => 'preset_demo',
    'label'       => __( 'Prebuilt Headers', 'mayosis-core' ),
