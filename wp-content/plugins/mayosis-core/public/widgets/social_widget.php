...
esc_html__('Mayosis Social', 'mayosis-core'), 

// Widget description
array( 'description' => esc_html__( 'Your site&#8217;s Social Profiles.', 'mayosis-core' ), ) 
);
}
...
<div class="clearfix"></div>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'facebook' )); ?>"><?php _e('Show Facebook', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'twitter' )); ?>"><?php _e('Show Twitter', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'pinterest' )); ?>"><?php _e('Show Pinterest', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'instagram' )); ?>"><?php _e('Show Instagram', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'behance' )); ?>"><?php _e('Show Behance', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'youtube' )); ?>"><?php _e('Show Youtube', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'linkedin' )); ?>"><?php _e('Show Linkedin', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'github' )); ?>"><?php _e('Show Github', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'slack' )); ?>"><?php _e('Show Slack', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'envato' )); ?>"><?php _e('Show Envato', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'dribbble' )); ?>"><?php _e('Show Dribbble', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'vimeo' )); ?>"><?php _e('Show Vimeo', 'mayosis-core'); ?></label></p>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'spotify' )); ?>"><?php _e('Show Spotify', 'mayosis-core'); ?></label></p>
    
    
		
		<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php printf( esc_html__( 'Target', 'mayosis-core' ), edd_get_label_singular() ); ?></label>
				<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>">
					<option value="self" <?php if ( $instance['target'] == 'self' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Self', 'mayosis-core' ); ?></option>
					<option value="blank" <?php if ( $instance['target'] == 'blank' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'blank', 'mayosis-core' ); ?></option>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'align' ) ); ?>"><?php printf( esc_html__( 'Align', 'mayosis-core' ), edd_get_label_singular() ); ?></label>
				<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'align' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'align' ) ); ?>">
					<option value="left" <?php if ( $instance['align'] == 'left' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Left', 'mayosis-core' ); ?></option>
					<option value="center" <?php if ( $instance['align'] == 'center' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Center', 'mayosis-core' ); ?></option>
					<option value="right" <?php if ( $instance['align'] == 'right' ) echo 'selected="selected"'; ?>><?php esc_html_e( 'Right', 'mayosis-core' ); ?></option>
    ...
    <label for="<?php echo esc_attr($this->get_field_id( 'without_bg' )); ?>"><?php _e('Show Icon Without Background', 'mayosis-core'); ?></label></p>
