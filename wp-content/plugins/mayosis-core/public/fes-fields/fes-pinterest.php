<?php
class FES_pinterest_profile_Field extends FES_Field {
    ...
    public $characteristics = array(
        ...
        'default'     => '',
        'size'        => '',
        'help'        => 'Add Pinterest Profile URL',
        'placeholder' => '',
    );

    public function set_title() {
        $title = _x( 'Pinterest', 'FES Field title translation', 'mayosis-core' );
