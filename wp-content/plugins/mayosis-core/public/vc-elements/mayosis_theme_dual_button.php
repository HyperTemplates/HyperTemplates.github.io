...
vc_map(array(
	...
	"name" => __("Mayosis Dual Button", 'mayosis-core') ,
	"description" => __("Dual Button", 'mayosis-core') ,
	"class" => "",
	...
	"params" => array(
		array(
			"type" => "dropdown",
			"heading" => __("Show Button Separator", 'mayosis-core') ,
		...
		array(
			"type" => "textfield",
			"heading" => __("Button Separator", 'mayosis-core') ,
		...
		array(
			"type" => "textfield",
			"heading" => __("Button A Text", 'mayosis-core') ,
		...
		array(
			"type" => "textfield",
			"heading" => __("Button A Link", 'mayosis-core') ,
		...
		array(
			"type" => "iconpicker",
			"heading" => __("Btn A Icon", 'mayosis-core') ,
			"param_name" => "btn_a_icon",
			"description" => __("Accepts a FontAwesome for Btn A value. (Ex. fa fa-angle-right)", 'mayosis-core') ,
			"value" => 'fa fa-angle-right',
			"group" => 'Button A'
		) ,
		array(
			"type" => "dropdown",
			"heading" => __("Style Of Button A ", 'mayosis-core') ,
			"param_name" => "button_a_style",
			"description" => __("Choose Button A Color Style", 'mayosis-core') ,
			"value" => array(
				'Color One' => 'sone',
				'Color Two' => 'stwo',
		...
		array(
            "type" => "colorpicker",
            "heading" => __('Gradient Color A', 'mayosis-core'),
        ...
        array(
            "type" => "colorpicker",
            "heading" => __('Gradient Color B', 'mayosis-core'),
			...
			array(
			"type" => "dropdown",
			"heading" => __("Show Video Popup Button One", 'mayosis-core') ,
			"param_name" => "button_video_poup_a",
			"description" => __("Show Video Popup On Button A", 'mayosis-core') ,
			"value" => array(
				'No' => '',
				'Yes' => 'data-lity'
			) , //Add default value in $atts
		...
		array(
			"type" => "colorpicker",
			"heading" => __("Custom Background Color", 'mayosis-core') ,
		...
		array(
			"type" => "colorpicker",
			"heading" => __("Custom Border Color", 'mayosis-core') ,
		...
		array(
			"type" => "colorpicker",
			"heading" => __("Custom Text Color", 'mayosis-core') ,
		...
		array(
			"type" => "textfield",
			"heading" => __("Button B Text", 'mayosis-core') ,
		...
		array(
			"type" => "textfield",
			"heading" => __("Button B Link", 'mayosis-core') ,
		...
		array(
			"type" => "iconpicker",
			"heading" => __("Btn B Icon", 'mayosis-core') ,
			"param_name" => "btn_b_icon",
			"description" => __("Accepts a FontAwesome for Btn B value. (Ex. fa fa-angle-right)", 'mayosis-core') ,
			"value" => 'fa fa-angle-right',
			"group" => 'Button B'
		) ,
		array(
			"type" => "dropdown",
			"heading" => __("Style Of Button B ", 'mayosis-core') ,
			"param_name" => "button_b_style",
			"description" => __("Choose Button B Color Style", 'mayosis-core') ,
			"value" => array(
				'Color One' => 'sone',
				'Color Two' => 'stwo',
				'Transparent' => 'transparent',
		...
		array(
			"type" => "dropdown",
			"heading" => __("Show Video Popup Button Two", 'mayosis-core') ,
			"param_name" => "button_video_poup_b",
			"description" => __("Show Video Popup On Button B", 'mayosis-core') ,
			"value" => array(
				'No' => '',
				'Yes' => 'data-lity'
			) , //Add default value in $atts
		...
		array(
			"type" => "textfield",
			"heading" => __("Margin Top", 'mayosis-core') ,
			"param_name" => "margin_top",
			"description" => __("Enter a positive integer value.", 'mayosis-core') ,
			"value" => 0,
			"group" => 'Style'
		) ,
		array(
			"type" => "textfield",
			"heading" => __("Margin Bottom", 'mayosis-core') ,
		...
		array(
			"type" => "dropdown",
			"heading" => __("Btn A Target Window", 'mayosis-core') ,
			"param_name" => "btn_a_target",
			"description" => __("Set the Btn A window for the button.", 'mayosis-core') ,
			"value" => array(
				'_self' => '_self',
				'_blank' => '_blank'
			) , //Add default value in $atts
		...
		array(
			"type" => "dropdown",
			"heading" => __("Btn B Target Window", 'mayosis-core') ,
			"param_name" => "btn_b_target",
			"description" => __("Set the Btn B window for the button.", 'mayosis-core') ,
			"value" => array(
				'_self' => '_self',
				'_blank' => '_blank'
			) , //Add default value in $atts
		...
		array(
			"type" => "colorpicker",
			"heading" => __("Separator Color", 'mayosis-core') ,
		...
		/*array(
		"type" => "colorpicker",
		"heading" => __("Text Color", 'mayosis-core'),
		"param_name" => "text_color",

		// "description" => __("Enter an btn_a_icon value.", 'mayosis-core'),
		...
		array(
			"type" => "textfield",
			"heading" => __("Class of Button A", 'mayosis-core') ,
			"param_name" => "class_a",
			"description" => __("Apply a custom CSS class if required.", 'mayosis-core') ,
			"value" => '',
			"group" => 'Style'
		) ,
		array(
			"type" => "textfield",
			"heading" => __("Class of Button B", 'mayosis-core') ,
			"param_name" => "class_b",
			"description" => __("Apply a custom CSS class if required.", 'mayosis-core') ,
			"value" => '',
			"group" => 'Style'
