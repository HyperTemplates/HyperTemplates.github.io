...
vc_map( array(
    ...
    "name"      => __("Mayosis Single Button", 'mayosis-core'),
    "description"      => __("Single Button", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Button Text", 'mayosis-core'),
            "param_name" => "btn_text",
		...
		array(
            "type" => "textfield",
            "heading" => __("Font Size", 'mayosis-core'),
	...
	array(
            "type" => "textfield",
            "heading" => __("Border Width", 'mayosis-core'),
	...
	array(
            "type" => "dropdown",
            "heading" => __("Style Of Button ", 'mayosis-core'),
            "param_name" => "button_main_style",
            "description" => __("Choose Button Color Style(Custom Color Set From Theme Option)", 'mayosis-core'),
	...
	array(
            "type" => "textfield",
            "heading" => __("Border Radius", 'mayosis-core'),
		...
		array(
            ...
            "param_name" => "z_index",
            "description" => __("Enter a integer value.", 'mayosis-core'),
			"value" => 0,
			"group" => 'Style'
        ),
		...
		array(
            "type" => "dropdown",
            "heading" => __("Target Window", 'mayosis-core'),
            "param_name" => "target",
            "description" => __("Set the target window for the button.", 'mayosis-core'),
		...
		array(
			"type" => "dropdown",
			"heading" => __("Show Video Popup Button", 'mayosis-core') ,
			"param_name" => "button_video_poup",
			"description" => __("Show Video Popup On", 'mayosis-core') ,
			"value" => array(
				'No' => '',
				'Yes' => 'data-lity'
		...
		/*array(
            ...
            //"description" => __("Enter an icon value.", 'mayosis-core'),
			"value" => '#ffffff'
        ),*/
