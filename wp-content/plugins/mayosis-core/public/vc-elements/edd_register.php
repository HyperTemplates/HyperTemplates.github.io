...
vc_map( array(
    ...
    "name"      => __("Mayosis Register", 'mayosis-core'),
    "description"      => __("Mayosis Edd Resgister", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
                        'type' => 'attach_image',
                        'heading' => __( 'Register Logo', 'mayosis-core' ),
             ...
             array(
            'type' => 'textfield',
            'heading' => __('Register Title', 'mayosis-core') ,
            'param_name' => 'register_title',
            'value' => __('', 'mayosis-core') ,
            'description' => __('Input Register Title', 'mayosis-core') ,
        ) ,
        array(
            'type' => 'textfield',
            'heading' => __('After Registration Redirect Url', 'mayosis-core') ,
            'param_name' => 'redirect_url',
            'value' => __('', 'mayosis-core') ,
            'description' => __('Input After Registration Redirect Url', 'mayosis-core') ,
        ) ,
        array(
            'type' => 'textfield',
            'heading' => __('Login Url', 'mayosis-core') ,
            'param_name' => 'registration_url',
            'value' => __('', 'mayosis-core') ,
            'description' => __('Input Login Url', 'mayosis-core') ,
        ) ,
		array(
            'type' => 'css_editor',
