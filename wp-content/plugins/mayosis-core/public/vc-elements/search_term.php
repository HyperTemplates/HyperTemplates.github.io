...
vc_map( array(
    ...
    "base"      => "search_term",
    "name"      => __("Mayosis Search Keywords", 'mayosis-core'),
    "description"      => __("Recent Search Keywords", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
            ...
            array(
			"type" => "dropdown",
			"heading" => __("Search Term Style", 'mayosis-core') ,
			"param_name" => "termstyle",
			"description" => __("Set search term style", 'mayosis-core') ,
			"value" => array(
				'Style One' => '1',
				'Style Two' => '2',
				'Style Three' => '3',
		...
		array(
            "type" => "colorpicker",
            "heading" => __('Change text color for style seven', 'mayosis-core'),
