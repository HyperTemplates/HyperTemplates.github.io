...
vc_map( array(
    ...
    "base"      => "dm_icon_box",
    "name"      => __('Mayosis Icon Box', 'mayosis-core'),
    "description"      => __('Mayosis Text with icon', 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "iconpicker",
            "heading" => __('Icon', 'mayosis-core'),
            "param_name" => "icon",
            "description" => __('Select Your Icon', 'mayosis-core'),
			"value" => 'fa fa-thumbs-o-up',
			"group" => 'General',
        ),
		    array(
                        'type' => 'attach_image',
                        'heading' => __( 'Custom Image', 'mayosis-core' ),
                        'param_name' => 'custom_image',
                        "group" => 'General',
                        'description' => __( 'Upload Custom Icon', 'mayosis-core' ),
                    ), 
		array(
            "type" => "textfield",
            "heading" => __('Custom Icon Width', 'mayosis-core'),
            "param_name" => "width_custom_image",
            'description' => __( 'Input without px', 'mayosis-core' ),
			"value" => '',
			"group" => 'General',
        ),
        array(
            "type" => "textfield",
            "heading" => __('Custom Icon Height', 'mayosis-core'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __('Icon Color', 'mayosis-core'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __('Title Color', 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __('Icon Background Color', 'mayosis-core'),
        ...
        array(
            "type" => "colorpicker",
            "heading" => __('Content Color', 'mayosis-core'),
	...
	array(
            "type" => "dropdown",
            "heading" => __('Alignment of Icon', 'mayosis-core'),
            "param_name" => "icon_align",
            "description" => __('Choose Icon Align', 'mayosis-core'),
	...
	array(
            "type" => "dropdown",
            "heading" => __('Alignment of Title', 'mayosis-core'),
            "param_name" => "title_align",
            "description" => __('Choose Title Align', 'mayosis-core'),
			"value"      => array( 'Left' => 'left', 'Center' => 'center', 'Right' => 'right' ), //Add default value in $atts
			"group" => 'Style',
        ),
        	...
        	array(
            "type" => "dropdown",
            "heading" => __('Alignment of Button', 'mayosis-core'),
            "param_name" => "btn_align",
            "description" => __('Choose Button Align', 'mayosis-core'),
			"value"      => array( 'Left' => 'left', 'Center' => 'center', 'Right' => 'right' ), //Add default value in $atts
			"group" => 'Style',
        ),
        	...
        	array(
            "type" => "dropdown",
            "heading" => __('Alignment of Content', 'mayosis-core'),
            "param_name" => "content_align",
            "description" => __('Choose Content Align', 'mayosis-core'),
			"value"      => array( 'Left' => 'left', 'Center' => 'center', 'Right' => 'right' ), //Add default value in $atts
			"group" => 'Style',
        ),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Title Font Size (with px)', 'mayosis-core'),
	...
	array(
            "type" => "dropdown",
            "heading" => __('Gradient Icon', 'mayosis-core'),
            "param_name" => "icon_gradient",
            "description" => __('Choose Gradient or Not', 'mayosis-core'),
        ...
        array(
            "type" => "dropdown",
            "heading" => __('Icon Beside Title', 'mayosis-core'),
            "param_name" => "icon_beside",
            "description" => __('Choose Icon Position', 'mayosis-core'),
			"value"      => array( 'No' => 'no','Yes' => 'yes' ), //Add default value in $atts
			"group" => 'Style',
        ),
		...
		array(
            "type" => "colorpicker",
            "heading" => __('Icon Color Gradient One', 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __('Icon Color Gradient Two', 'mayosis-core'),
        ...
        array(
            "type" => "dropdown",
            "heading" => __('Custom Image Background Type', 'mayosis-core'),
            "param_name" => "ci_bg_type",
            "description" => __('Choose Image Background Type', 'mayosis-core'),
         ...
         array(
            "type" => "colorpicker",
            "heading" => __('Custom Image Background Color', 'mayosis-core'),
        ...
        array(
            "type" => "colorpicker",
            "heading" => __('Custom Image Background Gradient One', 'mayosis-core'),
         ...
         array(
            "type" => "colorpicker",
            "heading" => __('Custom Image Background Gradient Two', 'mayosis-core'),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Custom Image Background Padding (with px)', 'mayosis-core'),
         ...
         array(
            "type" => "textfield",
            "heading" => __('Custom Image Background Border radius (with px or %)', 'mayosis-core'),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Custom Image Stacked on Top (with px or %)', 'mayosis-core'),
        ...
        array(
            "type" => "colorpicker",
            "heading" => __('Custom Button Background Color', 'mayosis-core'),
         ...
         array(
            "type" => "colorpicker",
            "heading" => __('Custom Button Text Color', 'mayosis-core'),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Custom Button Margin Top (with px or %)', 'mayosis-core'),
         ...
         array(
            "type" => "textfield",
            "heading" => __('Custom Button Margin Bottom (with px or %)', 'mayosis-core'),
            "param_name" => "cbtn_margin_bottom",
			"group" => 'Style',
        ),
        array(
            "type" => "textfield",
            "heading" => __('Custom Button Text', 'mayosis-core'),
        ...
        array(
            "type" => "textfield",
            "heading" => __('Custom Button URL', 'mayosis-core'),
            "param_name" => "cbtn_url",
			"group" => 'General',
        ),
		...
		array(
            "type" => "textarea",
            "heading" => __('Content', 'mayosis-core'),
            "param_name" => "content",
			"group" => 'General',
            //"description" => __("Enter a short description for your service.", 'mayosis-core')
        ),
        	array(
            "type" => "textfield",
