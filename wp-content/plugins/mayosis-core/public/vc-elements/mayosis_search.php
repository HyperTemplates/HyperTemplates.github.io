...
vc_map( array(
    ...
    "base"      => "dm_search",
    "name"      => __("Mayosis Search", 'mayosis-core'),
    "description"      => __("Mayosis Search Box", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
	 ...
	 array(
                        'type' => 'textarea',
                        'heading' => __( 'Search Placeholder Text', 'mayosis-core' ),
                        'param_name' => 'placeholder_text',
                        'value' => __( 'Search Now', 'mayosis-core' ),
                        'description' => __( 'The Search Placeholder Text', 'mayosis-core' ),
	"group" => 'General',
                    ),

        array(
            'type' => 'dropdown',
            'heading' => __( 'Search Style', 'mayosis-core' ),
