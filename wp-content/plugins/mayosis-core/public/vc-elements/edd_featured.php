...
vc_map( array(
    ...
    "base"      => "digital_edd",
    "name"      => __("Mayosis Featured Grid", 'mayosis-core'),
    "description"      => __("Mayosis Easy Digital Download Featured", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
	 array(
                        ...
                        'value' => __( 'Featured Edd', 'mayosis-core' ),
                        'description' => __( 'Title for Featured Section', 'mayosis-core' ),
                    ), 
