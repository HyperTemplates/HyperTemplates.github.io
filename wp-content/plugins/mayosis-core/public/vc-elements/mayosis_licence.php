...
<?php endif; ?>
	...
	<?php endwhile; else: ?>
                    ...
                    <div class="col-lg-12 pm-column-spacing">
                     <p><?php echo esc_attr('No posts were found.', 'mayosis-core'); ?></p>
                    </div>
                <?php endif; ?>
...
vc_map( array(
    ...
    "base"      => "dm_license",
    "name"      => __('Mayosis License', 'mayosis-core'),
    "description"      => __('Mayosis License Block', 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __('Amount of License Block to display:', 'mayosis-core'),
	 ...
	 array(
                    "type" => "textfield",
                    "heading" => __('License Group',  'mayosis-core'),
                    "param_name" => "license_category",
                    "value" =>'',
                    "description" => __('Enter a comma separated list of License Group IDs / names',  'mayosis-core'),
