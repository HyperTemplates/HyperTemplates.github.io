...
vc_map( array(
    ...
    "base"      => "dm_slider",
    "name"      => __("Mayosis Slider", 'mayosis-core'),
    "description"      => __("Mayosis Custom Slider", 'mayosis-core'),
    "class"     => "",
	...
	array(
            "type" => "textfield",
            "heading" => __("Amount of Slider to display:", 'mayosis-core'),
            "param_name" => "num_of_posts",
            "description" => __("Choose how many news slider you would like to display.", 'mayosis-core'),
			"value"      => (''), //Add default value in $atts
        ),
		
		array(
            "type" => "dropdown",
            "heading" => __("Slider Order", 'mayosis-core'),
            "param_name" => "post_order",
            "description" => __("Set the order in which slider will be displayed.", 'mayosis-core'),
			"value"      => array( 'DESC' => 'DESC', 'ASC' => 'ASC'), //Add default value in $atts
        ),
	
	array(
            "type" => "dropdown",
            "heading" => __("Carousel Arrow", 'mayosis-core'),
            "param_name" => "carousel_arrow",
            "description" => __("Set Carousel Arrow Display or Not.", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Color of Main Title", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Font A Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Font B Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Font A Hover Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Font B Hover Color", 'mayosis-core'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Button A Background Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button B Background Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button A Border Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button B Border Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button A Hover Background Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button B Hover Background Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button A Hover Border Color", 'mayosis-core'),
	...
	array(
            "type" => "colorpicker",
            "heading" => __("Button B Hover Border Color", 'mayosis-core'),
