...
vc_map(array(
	...
	"name" => __('Mayosis Contact Info', 'mayosis-core') ,
	"description" => __('Mayosis contact information box', 'mayosis-core') ,
	"class" => "",
	...
	"params" => array(
		array(
			'type' => 'textfield',
			'heading' => __('Address Widget Title', 'mayosis-core') ,
			'param_name' => 'address_widget',
			'value' => __('Address', 'mayosis-core') ,
			'description' => __('Input Address Widget Title', 'mayosis-core') ,
		) ,
		array(
			'type' => 'textarea',
			'heading' => __('Address Details', 'mayosis-core') ,
			'param_name' => 'content',
			'value' => __('37/5, Joarshahara,<br />Baridhara, <br />Dhaka-1229,Bangladesh', 'mayosis-core') ,
			'description' => __('', 'mayosis-core') ,
		) ,
		array(
			"type" => "colorpicker",
			"heading" => __('Color Of Titles', 'mayosis-core') ,
