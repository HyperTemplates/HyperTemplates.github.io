...
vc_map( array(
    ...
    "base"      => "dm_subscribe",
    "name"      => __("Mayosis Subscribe", 'mayosis-core'),
    "description"      => __("Mayosis Subscribe Box", 'mayosis-core'),
    "class"     => "",
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Subscribe Title", 'mayosis-core'),
            "param_name" => "title",
		...
		/*array(
            "type" => "textfield",
            "heading" => __("Animation Delay", 'mayosis-core'),
            "param_name" => "animation_delay",
            "description" => __("Accepts a positive integer value.", 'mayosis-core'),
			"value" => '0.3'
        ),*/
	...
	array(
	 ...
	 array(
                        'type' => 'textarea_html',
                        'heading' => __( 'Subscribe Description & Shortcode', 'mayosis-core' ),
                        'param_name' => 'subscribe_content_all',
                        'description' => __( 'Subscribe Description With any types od Shortcode', 'mayosis-core' ),
	"group" => 'General',
                    ),
	 array(
            "type" => "colorpicker",
