...
vc_map( array(
    "name" => __("Mayosis Logo Grid", 'mayosis-core'),
    "base" => "client_items",
	"category"  => __("Mayosis Elements", 'mayosis-core'),
	"description" => __('Mayosis Client Logo Grid', 'mayosis-core') ,
...
vc_map( array(
    "name" => __("Client Logo", 'mayosis-core'),
    "base" => "client_items_item",
	"category"  => __("Digital Elements", 'mayosis-core'),
	"icon" => get_template_directory_uri() . '/images/DM-Symbol-64px.png',
    "content_element" => true,
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Alt attribute", 'mayosis-core'),
            "param_name" => "el_title",
            "description" => __("Enter a descriptive alt attribute - this is used for SEO purposes.", 'mayosis-core'),
			"value" => ''
        ),
		
		array(
            "type" => "attach_image",
            "heading" => __("Image", 'mayosis-core'),
            "param_name" => "el_image",
            "description" => __("Upload an image for your slide.", 'mayosis-core')
        ),
